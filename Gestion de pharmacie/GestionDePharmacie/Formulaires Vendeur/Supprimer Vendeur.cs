...
{
    public partial class Supprimer_Vendeur : Form
    {
        public Supprimer_Vendeur()
        {
            InitializeComponent();
        }
        MYDBC db = new MYDBC();
        Vendeur res;
        Boolean b = true;
        private void Supprimer_Vendeur_Load(object sender, EventArgs e)
        {
